...
function auxin_define_options_info( $fields_sections_list ){
    ...
    $options[] = array(
        'title'       => __( 'Replay Title', 'phlox-pro' ),
...
/* ---------------------------------------------------------------------------------------------------
   ...
   $options[] = array(
    ...
    $sections[] = array(
        ...
        'title'       => __( 'Import Theme Options', 'phlox-pro' ),
        'description' => __( 'Import Theme Options', 'phlox-pro' ),
        'add_to'      => 'option_panel'
    );

    $options[] = array(
        'title'       => __( 'Theme options code', 'phlox-pro' ),
    ...
    $sections[] = array(
        ...
        'parent'      => 'tools-section', // section parent's id
        'title'       => __( 'Export Theme Options', 'phlox-pro' ),
        'description' => __( 'Export Theme Options', 'phlox-pro' ),
        'add_to'      => 'option_panel'
    );

    $options[] = array(
        'title'       => __( 'Export Theme Options', 'phlox-pro' ),
        'description' => __( 'Your theme options code which you can import later.', 'phlox-pro' ),
