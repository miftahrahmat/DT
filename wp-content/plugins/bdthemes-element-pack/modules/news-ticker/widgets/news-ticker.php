...
class News_Ticker extends Widget_Base {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bdt-news-ticker .bdt-news-ticker-label .bdt-news-ticker-label-inner:after' => 'border-left-color: {{VALUE}};',
				],
				'condition' => [
					'show_label' => 'yes'
				]
				...
				'slider-settings' => [
					...
					'bdt-slideshow' => [
						wp_json_encode(array_filter([
							...
							"max-height"        => $settings["news_ticker_height"]["size"],
	...
	public function render_date() {
		...
		echo 
			'<span class="bdt-margin-small-left bdt-margin-small-right">-</span><span class="bdt-post-grid-date bdt-text-small">'.esc_attr(get_the_date('M d, Y')).'</span>';		
	}
