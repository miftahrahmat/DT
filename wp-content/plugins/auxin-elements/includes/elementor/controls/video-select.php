...
/**
 * Elementor visual select control.
 *
 ...
 * @since 1.0.0
 */
class Control_Video_Select extends Base_Data_Control {
	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				<div class="aux-elementor-control-media elementor-control-tag-area elementor-control-preview-area" data-media-type="video">
